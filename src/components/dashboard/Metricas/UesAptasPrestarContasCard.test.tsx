...
vi.mock("@/hooks/useUesAptasPrestarContas", () => ({
  useUesAptasPrestarContas: () => mockQueryResult,
}));

import UesAptasPrestarContasCard from "./UesAptasPrestarContasCard";

describe("<UesAptasPrestarContasCard />", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockQueryResult = {
      data: undefined,
  ...
  it("sem systemName mostra placeholder", () => {
    render(<UesAptasPrestarContasCard />);
    expect(screen.getByText("Selecione um projeto")).toBeInTheDocument();
  });

  it("loading mostra skeletons", () => {
    mockQueryResult = { ...mockQueryResult, isLoading: true };
    render(<UesAptasPrestarContasCard systemName="Bens Físicos" />);
