...
import { getDisponibilidadeDosAmbientesProducao } from "@/actions/disponibilidade-dos-ambientes";
...
export async function GET(req: NextRequest) {
  ...
  try {
    const status = await getDisponibilidadeDosAmbientesProducao(project, host);
