...
export function AnalyticsTourOverlay() {
    ...
    useEffect(() => {
        if (!isAnalyticsTourActive) return;
    ...
    }, [isAnalyticsTourActive, currentStep, updateTargetPosition]);

    if (!isAnalyticsTourActive || !currentStep || !targetRect) return null;
            ...
            >
                ...
                <div className="flex items-center justify-between mt-5">
                    <span className="text-sm text-muted-foreground">
                        {analyticsTourStepIndex + 1}/{totalSteps}
                    </span>
                    <div className="flex gap-2">
                        ...
                        {analyticsTourStepIndex < totalSteps - 1 && (
                            <Button
                                size="sm"
                                onClick={nextAnalyticsStep}
