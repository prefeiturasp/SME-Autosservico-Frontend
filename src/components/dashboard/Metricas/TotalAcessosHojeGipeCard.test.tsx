...
vi.mock("@/hooks/useTotalAcessosHojeGipe", () => ({
  useTotalAcessosHojeGipe: () => mockQueryResult,
}));

import TotalAcessosHojeGipeCard from "./TotalAcessosHojeGipeCard";

describe("<TotalAcessosHojeGipeCard />", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockQueryResult = {
      data: undefined,
  ...
  it("sem systemName mostra placeholder", () => {
    render(<TotalAcessosHojeGipeCard />);
    expect(screen.getByText("Selecione um projeto")).toBeInTheDocument();
  });

  it("loading mostra skeletons", () => {
    mockQueryResult = { ...mockQueryResult, isLoading: true };
    render(<TotalAcessosHojeGipeCard systemName="GIPE" />);
