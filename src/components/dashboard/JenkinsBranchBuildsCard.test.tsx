...
describe("<JenkinsBranchBuildsCard />", () => {
    ...
    it("exibe label Falha quando status é FAILURE", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
    ...
    it("exibe label Em andamento e estado 'em andamento' quando build está em progresso", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
    ...
    it("exibe label Instável quando status é UNSTABLE", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
    ...
    it("exibe label Abortado quando status é ABORTED", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
    ...
    it("exibe label Desconhecido quando status é UNKNOWN", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
    ...
    it("exibe mensagem de erro com botão de retry quando isError é true", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
    ...
    it("exibe mensagem do servidor quando job não é encontrado", () => {
        render(
            <JenkinsBranchBuildsCard
                projectName="SME-NovoSGP/master"
                query={query({
