...
vi.mock("@/hooks/useAcessoAtivoSigla", () => ({
  useAcessoAtivoSigla: () => mockQueryResult,
}));

import AcessoAtivoSiglaCard from "./AcessoAtivoSiglaCard";

describe("<AcessoAtivoSiglaCard />", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockQueryResult = {
      data: undefined,
  ...
  it("sem systemName mostra placeholder", () => {
    render(<AcessoAtivoSiglaCard />);
    expect(screen.getByText("Selecione um projeto")).toBeInTheDocument();
  });

  it("loading mostra skeletons", () => {
    mockQueryResult = { ...mockQueryResult, isLoading: true };
    render(<AcessoAtivoSiglaCard systemName="Sigla" />);
