...
import ActiveUsersMetricCard from "./ActiveUsersMetricCard";

describe("<ActiveUsersMetricCard />", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockQueryResult = {
      data: undefined,
  ...
  it("sem systemName mostra placeholder", () => {
    render(<ActiveUsersMetricCard />);
    expect(screen.getByText("Selecione um projeto")).toBeInTheDocument();
  });

  it("loading mostra skeletons", () => {
    mockQueryResult = { ...mockQueryResult, isLoading: true };
    render(<ActiveUsersMetricCard systemName="SigPAE" />);
