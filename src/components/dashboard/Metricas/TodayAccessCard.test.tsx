...
vi.mock("@/hooks/useTodayAccessCount", () => ({
  useTodayAccessCount: () => mockQueryResult,
}));

import TodayAccessCard from "./TodayAccessCard";

describe("<TodayAccessCard />", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockQueryResult = {
      data: undefined,
  ...
  it("sem systemName mostra placeholder", () => {
    render(<TodayAccessCard />);
    expect(screen.getByText("Selecione um projeto")).toBeInTheDocument();
  });

  it("loading mostra skeletons", () => {
    mockQueryResult = { ...mockQueryResult, isLoading: true };
    render(<TodayAccessCard systemName="SigPAE" />);
